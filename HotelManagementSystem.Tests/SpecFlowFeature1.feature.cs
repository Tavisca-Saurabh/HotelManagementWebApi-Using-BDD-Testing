...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("User add hotel & verify that hotel in database by providing valid input")]
        [NUnit.Framework.CategoryAttribute("GetHotelByID")]
        [NUnit.Framework.TestCaseAttribute("10", "hotel4", null)]
        [NUnit.Framework.TestCaseAttribute("11", "hotel5", null)]
        [NUnit.Framework.TestCaseAttribute("12", "hotel6", null)]
        public virtual void UserAddHotelVerifyThatHotelInDatabaseByProvidingValidInput(string id, string name, string[] exampleTags)
        {
            string[] @__tags = new string[] {
                    "GetHotelByID"};
            if ((exampleTags != null))
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("User add hotel & verify that hotel in database by providing valid input", @__tags);
#line 19
this.ScenarioSetup(scenarioInfo);
#line 20
 testRunner.Given(string.Format("User provided valid Id \'{0}\'  and \'{1}\'for hotel", id, name), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
...
#line 23
 testRunner.When(string.Format("User calls GetHotelById api by \'{0}\'", id), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 24
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Get list of all the hotels added")]
        [NUnit.Framework.CategoryAttribute("Getlistofallthehotelsadded")]
        public virtual void GetListOfAllTheHotelsAdded()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Get list of all the hotels added", new string[] {
...
#line 38
 testRunner.And("User calls AddHotel api", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line 39
 testRunner.When("User calls GetAllHotels", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 40
 testRunner.Then("Verify all added hotels are present", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            this.ScenarioCleanup();
        }
    }
